...
All modifications to on-chain data happen through **transactions**. Transactions are mostly set of instructions that invoke Solana programs. Transactions are atomic, meaning they either succeed - meaning all the instructions have executed properly - or fail, as if the transaction hasn't been run. 
